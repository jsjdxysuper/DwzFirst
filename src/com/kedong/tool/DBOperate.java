...
public class DBOperate {
	...
	public boolean connect(String dbname) throws ClassNotFoundException, SQLException {
		String driver = Env.getInstance().getProperty(dbname + ".database" + ".driver");
		String url = Env.getInstance().getProperty(dbname + ".database" + ".url");
		String userid = Env.getInstance().getProperty(dbname + ".database" + ".userid");
		String password = Env.getInstance().getProperty(dbname + ".database" + ".password");
